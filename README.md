...
- **A proper diff viewer.** Word-level diffs, ~235 highlighted languages in GitHub
  light, GitHub dark or JetBrains Darcula, expandable context between hunks, rendered
  markdown and mermaid, image previews, and lazy rendering so a huge branch stays
  responsive.
